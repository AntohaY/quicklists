...
export class HomeComponent {
  ...
  editChecklist(checklistId: string) {
    this.checklistService.update(checklistId, {id: checklistId, ...this.checklistForm.getRawValue()});
  }
  ...
  constructor(private fb: FormBuilder, private checklistService: ChecklistService, public routerOutlet: IonRouterOutlet, private alertCtrl: AlertController){}
}
@NgModule({
  imports: [
    CommonModule,
